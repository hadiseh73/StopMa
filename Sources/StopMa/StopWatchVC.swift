...
public class StopWatchVC: UIViewController, UITableViewDelegate {
    
    public static let storyboardVC = UIStoryboard(name: "StopWatch", bundle: Bundle.module).instantiateInitialViewController()!
...
extension StopWatchVC: CLLocationManagerDelegate {
